/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bcb9db85e8571edd4067dda08b6c154e)
// Runtime types generated with workerd@1.20250525.0 2025-05-29 
declare namespace Cloudflare {
	interface Env {
		JETSTREAM_COLLECTIONS: string;
		WEBHOOK_URL: string;
		WEBHOOK_BEARER_TOKEN: string;
		JETSTREAM_PROCESSOR: DurableObjectNamespace<import("./src/index").JetstreamProcessor>;
		JETSTREAM_QUEUE: Queue;
	}
}
